...
describe("default model resolver", () => {
  ...
  it("should support known model listing", () => {
    expect(Object.keys(Models)).to.be.equal([
      ...
      "bokeh.models.shapes.AnnularWedge",
      "bokeh.models.shapes.Annulus",
      "bokeh.models.shapes.Arc",
      "bokeh.models.shapes.ArrowHead",
      "bokeh.models.shapes.Bezier",
      "bokeh.models.shapes.Box",
      "bokeh.models.shapes.Circle",
      "bokeh.models.shapes.Label",
      "bokeh.models.shapes.Marker",
      "bokeh.models.shapes.NormalHead",
      "bokeh.models.shapes.OpenHead",
      "bokeh.models.shapes.Segment",
      "bokeh.models.shapes.Spline",
      "bokeh.models.shapes.TeeHead",
      "bokeh.models.shapes.VeeHead",
      "bokeh.models.shapes.Wedge",
    ])
  })
})
